...
-- 切换到 blog 数据库，以 blog 用户身份执行后续脚本
\c blog blog
...
-- 其他项目可以在这里添加
-- ============================================
-- CREATE USER other_project WITH PASSWORD 'password';
-- CREATE DATABASE other_project OWNER other_project;
-- GRANT ALL PRIVILEGES ON DATABASE other_project TO other_project;
